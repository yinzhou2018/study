#ifndef CEF_CEFOSR_OSR_RENDERER_H_
#define CEF_CEFOSR_OSR_RENDERER_H_
#pragma once
...
class OsrRenderer {
 ...
 private:
  ...
  inline bool IsTransparent() const { return CefColorGetA(settings_.background_color) == 0; }
...
#endif  // CEF_CEFOSR_OSR_RENDERER_H_
