...
export function ButtonPad({ onAction }: ButtonPadProps) {
  return (
    <div className="button-pad">
      ...
      <Button label="÷" variant="operator" onPress={() => onAction({ type: 'OPERATOR', op: '/' as Operator })} />
      ...
      <Button label="×" variant="operator" onPress={() => onAction({ type: 'OPERATOR', op: 'x' as Operator })} />
      ...
      <Button label="0" onPress={() => onAction({ type: 'DIGIT', digit: '0' })} />
